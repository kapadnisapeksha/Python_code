...
When there is an error in value in any of the 2 input arguments, the program should raise a ValueError Exception and print the message shown in the sample output.
